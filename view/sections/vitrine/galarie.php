...
<head>
    ...
    <title>Amicale_des_étudiants_de_dakar</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="public/templates/templateVitrine/assets/img/logoUcab-removebg-preview.png" rel="icon">
    <link href="public/templates/templateVitrine/assets/img/logoUcab-removebg-preview.png" rel="apple-touch-icon">
    ...
    <link href="public/templates/templateVitrine/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
    ...
    <link href="public/templates/templateVitrine/assets/css/style.css" rel="stylesheet">
...
--------------------------------------------------------------*/
    .contact .info {
        border-top: 3px solid #3B186E;
        border-bottom: 3px solid #3B186E;
        padding: 30px;
        background: #fff;
        width: 100%;
        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                ...
                <a href="home" class="logo d-flex align-items-center">
                    ...
                    <img src="UpConstruction/assets/img/logoUcab-removebg-preview.png" alt="logoAmical">
                    <h1 class="sitename">FST UCAB </h1> <span>.</span>
                </a>
            </div>
        ...
        <section id="portfolio" class="portfolio">
          ...
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active"> <a href="home">Accueil</a></li>
              <li data-filter=".filter-app"><a href="home">Photo</a></li>
            </ul>
          </div>
        </div> -->
          ...
          ?>
                    ...
                    <div class="col-lg-3 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap" style="height:290px">
                            <img src="public/images/<?= $galerie['photo']?>" class="img-fluid" alt="">
                            <div class="portfolio-links">
                                <a href="public/images/<?= $galerie['photo']?>" data-gallery="portfolioGallery"
