      ...
      <div class="pagetitle">
          ...
          <nav>
              <ol class="breadcrumb">
                  ...
                  <!-- <li class="breadcrumb-item"><a href="listeGalerieVideo">Liste Video</a></li> -->
      ...
      <section class="section">
          <div class="row">
              <div class="col-lg-12">
                  ...
                  <div class="card">
                      <div class="card-body">
                          <h5 class="card-title text-center fs-4"># Ajout Photo</h5>
                          <hr>
                          <form action="galerieController" class="mx-auto col-lg-6" method="post"
                              ...
                              <div class="row">
                                  <div class="col-lg-12 mt-3">
                                      <button type="submit" name="frmAddGalerie"
